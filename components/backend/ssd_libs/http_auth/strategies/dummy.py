...
from ssd_libs.http_auth import Client, interfaces
from ssd_libs.http_auth.strategies.base import BaseStrategy
...
class Dummy(BaseStrategy):
    ...
    def __init__(
        self, client_factory: interfaces.ClientFactory = None, **client_params
    ):
