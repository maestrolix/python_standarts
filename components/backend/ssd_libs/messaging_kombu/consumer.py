...
from ssd_libs.messaging_kombu.handlers import MessageHandler, SimpleMessageHandler
from ssd_libs.messaging_kombu.scheme import BrokerScheme
...
class KombuConsumer(ConsumerMixin):
    ...
    def register_function(self, function: AnyCallable, *queue_names: str, late_ack: bool = True):
